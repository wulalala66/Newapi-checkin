...
def send_serverchan_notification(results: List[Dict[str, Any]], execution_time: Optional[str] = None,
    ...
    # 构建标题(mode='gwent' 时用于维云翻卡/任务报告)
    label = '维云翻卡' if mode == 'gwent' else 'NewAPI 签到'
    if fail_count == 0:
